...
const StepOneScreen: React.FC = () => {
  ...
  return (
    <div className="flex justify-evenly items-center min-h-screen px-20 md:pl-40 bg-bg-dark grad overflow-y-hidden">
      ...
      <div className="text-left text-white w-1/2">
        ...
        <div className="flex items-center">
          ...
          <p className="text-desc">Tenant selects the property</p>
        </div>
      ...
      <div className="absolute top-2/3 left-2/3 transform -translate-x-1/2 -translate-y-1/2">
        <div className="w-80 h-[570px] bg-black rounded-[3rem] border-4 border-gray-800 p-2 relative">
          ...
          <div className="w-full h-full bg-white rounded-[2.5rem] overflow-hidden">
            <StepOne setScrollProgress={scrollPosition} />
          </div>
        </div>
      </div>
    </div>
